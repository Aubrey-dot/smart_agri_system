...
static void ip_event_cb(void *arg, esp_event_base_t event_base, int32_t event_id, void *event_data){
    ...
    switch(event_id){
        case (IP_EVENT_STA_GOT_IP):
            ...
            ESP_LOGI(TAG, "Git IP: " IPSTR, IP2STR(&event_ip->ip_info.ip));
            wifi_retry_count = 0;
        ...
        case(IP_EVENT_GOT_IP6):
            ...
            break;
        default:
            ESP_LOGI(TAG, "IP event no handled");
            break;
    }
}
    ...
    ESP_LOGI(TAG, "handling WIFI event, event code 0x%" PRIx32, event_id);
        switch(event_id){
            ...
            case(WIFI_EVENT_STA_START):
                ESP_LOGI(TAG, "WIFI started, connecting AP......");
                esp_wifi_connect();
                break;
            ...
            case(WIFI_EVENT_STA_DISCONNECTED):
                ...
                if(wifi_retry_count < WIFI_RETRY_ATTEMPT){
                    ...
                    ESP_LOGI(TAG, "Reconnecting Failed");
