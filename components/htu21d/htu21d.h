...
#define HTU21D_CMD_TEMP 0xF5 //start humidity measurement no-hold master mode
#define HTU21D_CMD_RESET 0xFE //reset to default state

//--------------------TIMING (ms)----------------------------------
#define HTU21D_RESET_DELAYS_MS  15
...
esp_err_t htu21d_read(i2c_port_t port, htu21d_data_t *data);
